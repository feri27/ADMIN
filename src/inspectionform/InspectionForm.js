...
class InspectionForm extends Component {
  ...
  updateForm(callback){
    //   let rawForm = '[{"title":"Test","toolType":"CHECK_BOXES","inline":false,"defaultValue":"","placeholder":"","description":"","validation":{"isReadOnly":false,"isRequired":false,"min":6,"max":6},"checkBoxes":[]}]';
