...
function Client() {
  return (
            ...
            <div className="px-5 py-4">
              ...
              <thead>
              <tr>
                <th colSpan={4} class="border text-left px-4 bg-blue-100 text-blue-900 border-slate-300 py-4">CLIENT DETAIL</th>
              </tr>
              </thead>
              <tbody>
              <tr>
                <td class="border border-slate-300 px-4 py-4">
                <InputLabel title="Client Type" />
                </td>
              ...
              <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                ...
                <td class="border border-slate-300 px-4">
                <InputLabel title="Tax/Business No." />
                </td>
                <td class="border border-slate-300 px-4">
              ...
              <tr>
                <td class="border border-slate-300 px-4 py-4">
                <InputLabel title="Client Name" />
                </td>
                <td colSpan={4} class="border border-slate-300 px-4">
                <SimpleInput type="text" placeholder="...." />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="border border-slate-300 px-4 py-4">
                <InputLabel title="Sex" />
                </td>
                <td class="border border-slate-300 px-4">
                
                <SimpleSelect items={["Prefer not to say","Male", "Female"]} />
                ...
                <td class="border border-slate-300 px-4">
                <SimpleInput type="date" placeholder="...." />
                </td>
              </tr>
              <tr>
                <td class="border border-slate-300 px-4 py-4">
                ...
                <td colSpan={4} class="border border-slate-300 px-4">
                <SimpleInput type="email" placeholder="Enter Email" />
                </td>
              </tr>
              <tr>
                <th colSpan={4} class=" text-left px-4 border bg-blue-100 text-blue-900 border-slate-300 py-4">ADDRESS DETAILS</th>
              </tr>
              <tr>
                <td class="border border-slate-300 px-4 py-4">
