  ...
  return (
    <div className="px-5 py-4">
              ...
              <tr>
                ...
                <InputLabel title="Document Type" />
                </td>
                <td class="border border-slate-300 px-4">
                <InputLabel title="Title" />
                </td>
                <td class="border border-slate-300 px-4">
                <InputLabel title="ID Type" />
                </td>
                <td class="border border-slate-300 px-4">
                <InputLabel title="ID Number" />
                </td>
                <td class="border border-slate-300 px-4">
                ...
                <tr key={index}>
                <td class="border border-slate-300 px-4 py-4">
                <SimpleSelect items={["Identification", "Business Documents", "Photographs","Other"]} />
                </td>
                <td class="border border-slate-300 px-4">
                ...
                <td class="border border-slate-300 px-4">
                <SimpleInput type="file" placeholder="...." />
                </td>
