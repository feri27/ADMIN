  ...
  return (
    ...
    >
      <div className="hidden md:inline-flex flex-1">
        <input
          type="text"
          className="lg:w-1/3 border border-r-0 border-gray-300 rounded-none rounded-l-md font-light focus:ring-0 focus:border-cyan-500"
          placeholder="Search..."
        />
        <button className="px-3 rounded-none rounded-r-md bg-cyan-600 hover:bg-cyan-700 text-cyan-200 focus:outline-none">
