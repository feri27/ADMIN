  ...
  return (
    <div className="flex flex-col space-y-2 bg-gray-50 rounded px-4 r py-4">
      <div className="flex flex-row px-1 py-4 justify-between items-baseline ">
        ...
        <h4 className="font-medium text-cyan-900 py-1">All Inspection overview</h4>
      </div>
      <div className="shadow ounded-b-md overflow-x-auto rounded-md">
        <table className="min-w-full divide-y">
          <thead className="bg-gray-100">
            <tr>
              <TableHeader title="Tipe" />
              <TableHeader title="Client" />
              <TableHeader title="Location/Assets" />
              <TableHeader title="Location" />
              <TableHeader title="Address" />
              <TableHeader title="Parish" />
              <TableHeader title="Distric" />
      ...
      <div className="flex flex-row-reverse">
        ...
        >
          ...
          <button className="px-4 py-2 focus:outline-none text-white bg-cyan-600">
            3
          </button>
